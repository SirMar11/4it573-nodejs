...
```
*/
export declare function memoizeDecorator<FunctionToMemoize extends AnyFunction, CacheKeyType>(options?: Options<FunctionToMemoize, CacheKeyType>): {
    <This, ArgumentsType extends readonly unknown[], ReturnValueType>(target: (this: This, ...arguments_: ArgumentsType) => ReturnValueType, context: ClassMethodDecoratorContext<This, (this: This, ...arguments_: ArgumentsType) => ReturnValueType>): (this: This, ...arguments_: ArgumentsType) => ReturnValueType;
    <This, ReturnValueType>(target: (this: This) => ReturnValueType, context: ClassGetterDecoratorContext<This, ReturnValueType>): (this: This) => ReturnValueType;
};
/**
